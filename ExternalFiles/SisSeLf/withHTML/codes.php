...
if(!is_file('random.json'))
	file_put_contents('random.json', '{"name":["Random Name 1","Random Name 2"],"bio":["@SisSeLf 1","@SisSeLf 2","@SisSeLf 3"]}');
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʜᴀsʜᴛᴀɢ ᴍᴏᴅᴇ ɴᴏᴡ ɪs $m[2]"]);
}
//============== Mention Mode On | Off ===============
if(preg_match("/^[\/\#\!]?(mention) (on|off)$/i", $text)){
preg_match("/^[\/\#\!]?(mention) (on|off)$/i", $text, $m);
yield $this->filePutContents('mention.txt', $m[2]);
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴍᴇɴᴛɪᴏɴ ᴍᴏᴅᴇ ɴᴏᴡ ɪs $m[2]"]);
}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴍᴇɴᴛɪᴏɴ 2 ᴍᴏᴅᴇ ɴᴏᴡ ɪs $m[2]"]);
}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʀᴇᴠᴇʀsᴇ ᴍᴏᴅᴇ ɴᴏᴡ ɪs $m[2]"]);
}
...
$load = sys_getloadavg();
$mem_using = round(memory_get_usage() / 1024 / 1024,1);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => "» ᴏᴘᴇɴ ᴛʜᴇ help game . . . !", 'parse_mode' => 'MarkDown']);
...
if(preg_match("/^[\/\#\!]?(setbio) (.*)$/i", $text)){
	...
	if( strlen( $m[2] ) > 70 and !in_array($from_id, $adminsSK)) {
		$this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "متن داده شده بیشتر از 70 حرف داره . دستور اجرا نشد ✖"]);
	}else{
		yield $this->account->updateProfile(['about' => $m[2]]);
		file_put_contents('bio.txt', $m[2]);
		$this->messages->sendMessage(['peer' => $peer, 'message' => "این دستور غیر فعال شده، از کنترل پنلی که دراختیارتون قرار گرفته استفاده کنید ."]);
	}
}

if($text == 'شمارش' or $text == 'count' or $text == 'ش') {
		yield $this->messages->sendMessage(['peer' => $peer, 'message' => "１"]);
		...
		yield $this->messages->sendMessage(['peer' => $peer, 'message' => "مدرک "]);
		# yield $this->messages->sendScreenshotNotification(['peer' => $peer, 'reply_to_msg_id' => $msg_id]);
	}
	
	if($text=='فش' or $text=='Fosh'){
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' خب خب خب بیناموس تُ عرقِ پشمِ کیرِ سگِ کی باشی ک بخای برا من بشاخی گداناموس مادرتو میگیرم از کیون حامله میکنم کصشو با	گچو سیمان پلمپ میکنم ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' تمام مردم چین با سر تو کص مادرت بالاباش']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'با هواپیما میرم تو کص مادرت مادر فرودگاه 😂✈️']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'بالاباش نن نن کن بخندونمون ناموس پابوس ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننت کیون میده پول میگیره میره برا شوهرش تریاک میگیره کیرم تو کانون سرد خانوادت']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' یتیم بچه پرورشگاهی ننه عقدعی ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' امروز من	باید مادرتو عروس کنم حقیر بی نوا کلت از گشنگی باد کرده بت پیشنهاد سکس با مادرت میدم قبول نمیکنی ؟ دوزار میندازم کف دستت برو باش نون خشک بخر یتیمک توسری خور']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' ننه کیردزد']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننه کیرخور']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننه کیریاب ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننه کیرقاپ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننه کص کپک زده']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننه پاکستانی نجس']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'برو مشقاتو بنویس وگرنه همین خودکارو دفترکتابتو میکنم تو کصمادرت']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '	دوتا لوله فالوپ کص مادرتو با اره موتوری جدا میکنم میندازم جلو خالت ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'جمجمه ی مادرتو با کیر میشکنم']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'کصمادرتو با قمه تیکه تیکه میکنم']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' عین قیمت طلا هی کیرم برا مادرت میره بالاپایین ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' ننه صلواتی کوشی ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '	ننه دهه شصتی ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'با کیرم چشا مادرتو کور میکنم']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' ننه لاشخورِ سکس پرست']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننه کیرسوار 😂']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' میزارمت سر کیرم پرتت میکنم تو کیون مادرت ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'بیناموس بیا بالابینم سالها بالا باش مادرتو میخام زجرکش کنم']);

yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟏']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟐']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟑']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟒']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟓']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟔']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟕']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟖']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟗']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => '𝟏𝟎']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' دیگه ک چصشاخی نمیکنی بینامیوس ؟؟ انچنان کیری حواله ی مادرت بکنم ک حافظش بپره ']);

}

if($text=='فش2' or $text=='Fosh2'){
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' دوباره ک چصشاخی کردی بچه سال یتیم پرورشگاهی	']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' ایندفه دیگه مادرتو عین گوسفند سر میبرم ک دیگه چصشاخی نکنی ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ننتو کباب میکنم میندازم جلو سگام ']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' میرم سراغ خاله هات ممه های تک تکشونو با چاقو میوه خوری میبرم میپزم میدم سگام بخورن حال کنن']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'ابجیاتو ورمیدارم رو صورتشون میشاشم تمیزشون میکنم میفروشمشون ب عربا ک ب عنوان برده هرشب	کیون بدن و از کوچیک بودن کیر عرب های جاهل و	سوسمار خور رنج بکشن و بطور عجیبی خمار کیر گنده بشن']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'برادرا کیونیتم میندازم جلو سگام ک هر ده دیقه یبار کیونشون مورد گایش شدید سگها قرار بگیره و بعد چنوخت از شدت درد بمیرن']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => 'کل نوامیس خاندانتو ب بردگی میگیرم و بشون دستور میدم ک هرشب بمدت یک ساعت برا سگام ساک بزنن']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' کل کسایی ک تو خاندانت ادعای مرد بودن میکنن رو از خایه های عدسیشون با نخ خیاطی اویزون میکنم']);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => ' دیگه چیزی نموند برات بیهمچیز کل خاندانتو ب روش های مختلف و متنوع مورد تجاوز جنسی قرار دادم و ب قتل رسوندمشون']);
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🚧___________________🛵']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🚧_________________🛵']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🚧_______________🛵']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🚧_____________🛵']);
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '??🛵']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'وای تصادف شد']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'وای موتورم بـگا رف']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'ریدم تو موتورم']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '💥BOOM💥']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'قان قان گرفتیمش خودع کزخلشع😐🚶‍♂️']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'اخ اخ گاز گرفتی ک😐']);
yield $this->sleep(0.4);

}
if($text=='جق' or $text=='jaq'){
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'درحال جق....']);
yield $this->sleep(0.4);
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'کمر نموند برامون بمولا😐']);
}
...
if ($text == '/updateFake' or $text=='آپدیت فیک'  or $text=='آپدیت شو') {
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "👺🎣💳"]);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "💵🤑میشورم 100درصد ورمیدارم تبرم نیسم🤑💵"]);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🖕fucking you🖕🏿']);
}
if($text == '/test'){
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️']);
yield $this->sleep(0.4); 
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬛️']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬜️⬛️⬛️']);
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️⚫️⚪️']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'تست سرعت انجام شد!
🧭 سرعت ربات :
♻️ ⁸ᴍɢₛ']);
}
...
yield $this->messages->sendMessage(['peer' => $peer, 'message' => "❶⓿"]);
yield $this->sleep(0.4);
yield $this->messages->sendMessage(['peer' => $peer, 'message' => "پخخ بای فرزندم شمارش خوردی🤣🤣"]);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' =>'خندیدم بسه از این مطالب خنده دار نفرس😐']);
}
...
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'وای کرونارو گاییدیم']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🍑_👈']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '✌انگشت شد✌']);
}
if ($text == 'جقیم' or $text == 'jagh2') {
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'B=======✊🏻=D']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'B=====✊🏻===D']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'B==✊🏻======D']);
...
🧑‍🦯']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'چیو نگاه میکنی ریدیم ب هیکل یاروع دیگ😂']);
}
if($text=='سفید کون' or $text=='کون سفید'){
yield $this->messages->editMessage(['peer' => $peer, 'message' => "کون"]);
yield $this->sleep(0.4);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => "کون سفید"]);
yield $this->sleep(0.4);

yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => "کون سفید من"]);
yield $this->sleep(0.4);

yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => "کون سفید من چطورع"]);
yield $this->sleep(0.4);

yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => "یع دس مرامی دارکوبی بزن❤️"]);
yield $this->sleep(0.4);
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '💩💩💩💩💩']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '|همش تو کص ننه بدخواه??🖕|']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '💙💙💙💙']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '❣️I Love❣️']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '💙💙💙💙']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '👑entire??']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🌵💥🎈']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '💥Bommmm💥']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '💛🧡❤️💚']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '😍Im crazy about you😍']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🏥__________🏃‍♂️______________🐝']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🏥______🏃‍♂️_______🐝']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🏥______🏃‍♂️_____🐝']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🏥___🏃‍♂️___🐝']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🏥_🏃‍♂️_🐝']);
yield $this->sleep(0.4);
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => 'در رفت عه☹️🐝']);
}
...
yield $this->messages->editMessage(['peer' => $peer, 'id' => $msg_id, 'message' => '🏃‍♂??_______🏃😱😳🚶‍♂________🐝']);
yield $this->sleep(0.4);
...
if(preg_match("/^[\/\#\!]?(najva|نجوا) (.*)$/i", $text)){
    ...
    if($type3 == "supergroup"||$type3 == "chat"){
        ...
        $mu = $m[2];
        if(mb_strlen($mu) > 190){
            yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» طول نجوا نباید بیشتر از 190 کاراکتر باشد !", 'parse_mode' => 'markdown' ]);
            exit;
        }
...
// اطلاعات آب و هوا
if(preg_match("/^[\/\#\!]?(weather|اب و هوا) (.*)$/i", $text)){
preg_match("/^[\/\#\!]?(weather|اب و هوا) (.*)$/i", $text, $m);
if($type3 == "supergroup"||$type3 == "chat"||$type3 == "user"){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʀᴇᴄᴇɪᴠɪɴɢ ( `$m[2]` ) ᴄɪᴛʏ ᴡᴇᴀᴛʜᴇʀ ɪɴғᴏʀᴍᴀᴛɪᴏɴ . . . !", 'parse_mode' => 'markdown' ]);
...
yield $this->messages->sendMessage(['peer' => $peer,'message' => "» ᴇɴᴛᴇʀᴇᴅ ᴄɪᴛʏ ɪs ɪɴᴠᴀʟɪᴅ !", 'parse_mode' => 'markdown','reply_to_msg_id' =>$msg_id]);
}}}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜᴇ ( `$txxt` ) ᴡᴏʀᴅ ᴀʟʀᴇᴀᴅʏ ᴇxɪsᴛs ɪɴ ᴛʜᴇ ᴀɴsᴡᴇʀ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}
}
// Del
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴀɴsᴡᴇʀ ʟɪsᴛ ɪs ᴇᴍᴘᴛʏ !",'parse_mode'=>'MarkDown']);
}
}
// Clean
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ᴇɴᴇᴍʏ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}else{
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɪs ɴᴏᴛ ɪɴ ᴛʜᴇ ᴇɴᴇᴍʏ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}
}
}
}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$peer) ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ᴇɴᴇᴍʏ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}else{
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$peer) ɪs ɴᴏᴛ ɪɴ ᴛʜᴇ ᴇɴᴇᴍʏ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}
}
// Set
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɴᴏᴡ ɪɴ ᴇɴᴇᴍʏ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}else{
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴡᴀs ɪɴ ᴇɴᴇᴍʏ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}
}
}}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ ᴛʜᴇ ᴇɴᴇᴍʏ ʟɪsᴛ . . . !",'parse_mode'=>'MarkDown']);
$txxxt = "• ᴇɴᴇᴍʏ ʟɪsᴛ :
=-=-=-=-=-=-=-=-=-=-=
";
$counter = 1;
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴇɴᴇᴍʏ ʟɪsᴛ ɪs ᴇᴍᴘᴛʏ !",'parse_mode'=>'MarkDown']);
}
}
// Clean List
...
$data['enemies'] = [];
file_put_contents("data.json", json_encode($data,448));
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴇɴᴇᴍʏ ʟɪsᴛ ɴᴏᴡ ɪs ᴇᴍᴘᴛʏ !",'parse_mode'=>'MarkDown']);
}
//============================= Silent Tools ==================================
// Del
//====================
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ sɪʟᴇɴᴛ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}else{
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɪs ɴᴏᴛ ɪɴ ᴛʜᴇ sɪʟᴇɴᴛ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
}
}
}}
// Set
	...
	if($replyToId){
		if($type3 == 'supergroup' or $type3 == 'chat'){
			...
			if(!in_array($messag, $data['silents'])){
				...
				yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɴᴏᴡ ɪɴ sɪʟᴇɴᴛ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
			}else{
				yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴡᴀs ɪɴ sɪʟᴇɴᴛ ʟɪsᴛ !",'parse_mode'=>'MarkDown']);
			}
		}
	}
}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ ᴛʜᴇ sɪʟᴇɴᴛ ʟɪsᴛ . . . !",'parse_mode'=>'MarkDown']);
$txxxt = "• sɪʟᴇɴᴛ ʟɪsᴛ :
=-=-=-=-=-=-=-=-=-=-=
";
$counter = 1;
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sɪʟᴇɴᴛ ʟɪsᴛ ɪs ᴇᴍᴘᴛʏ !",'parse_mode'=>'MarkDown']);
}
}
// Clean List
...
$data['silents'] = [];
file_put_contents("data.json", json_encode($data,448));
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sɪʟᴇɴᴛ ʟɪsᴛ ɴᴏᴡ ɪs ᴇᴍᴘᴛʏ !",'parse_mode'=>'MarkDown']);
}
//============== Ping ==============
...
$mem_using = round(memory_get_usage() / 1024 / 1024,1);
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴍᴇᴍᴏʀʏ ᴜsɪɴɢ : **$mem_using** MB",'parse_mode'=>'MarkDown']);
}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʏᴏᴜʀ ɪᴅ : `$messag`", 'parse_mode' => 'markdown']);
} else {
if($type3 == 'user'){
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʏᴏᴜʀ ɪᴅ : `$peer`", 'parse_mode' => 'markdown']);
}}} else {
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢʀᴏᴜᴘ ɪᴅ : `$peer`", 'parse_mode' => 'markdown']);
}
}
//================ Flood ================
...
$count = $m[2];
$txt = $m[3];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ғʟᴏᴏᴅɪɴɢ ᴛᴇxᴛ ( `$txt` ) ᴄᴏᴜɴᴛ ( `$count` ) . . . !",'parse_mode' => 'markdown']);
for($i=1; $i <= $count; $i++){
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ ᴀ ᴏᴍᴇɴ ʜᴀғᴇᴢ ғᴏʀ ʏᴏᴜ . . . !",'parse_mode'=>'MarkDown']);
$inputMediaPhotoExternal = ['_' => 'inputMediaPhotoExternal', 'url' => $add];
$this->messages->sendMedia(['peer' => $peer, 'media' => $inputMediaPhotoExternal ,'reply_to_msg_id' => $msg_id,'message' => "» ʏᴏᴜʀ ᴏᴍᴇɴ ʜᴀғᴇᴢ ɪs ʀᴇᴀᴅʏ =)"]);
}
}
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴍᴇᴀɴɪɴɢ ( `$match` ) ғᴀʀsɪ ᴡᴏʀᴅ . . . !",'parse_mode'=>'MarkDown']);
if($p !=NULL){
yield $this->messages->sendMessage(['peer' => $peer, 'message' => "» کلمه اولیه : `$match`
» معنی :
» $p", 'parse_mode'=>"MarkDown",'reply_to_msg_id' => $msg_id,
]);
}else{
yield $this->messages->sendMessage(['peer' => $peer, 'message' => "» ʏᴏᴜʀ ᴡᴏʀᴅ ɴᴏᴛ ғᴏᴜɴᴅ !", 'parse_mode'=>"MarkDown",'reply_to_msg_id' => $msg_id,
]);
}
}}
//================ Git Hub ================
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ ᴛʜᴇ ( `$mu` ) ɢɪᴛʜᴜʙ ғɪʟᴇ . . . ! ",'parse_mode'=>"MarkDown"]);
...
if($type3 == 'user'){
yield $this->contacts->unblock(['id' => $peer]); yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴜɴʙʟᴏᴄᴋᴇᴅ !"]);
}
}
}
...
if($type3 == 'user'){
yield $this->contacts->block(['id' => $peer]); yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙʟᴏᴄᴋᴇᴅ !"]);
}
}
}
//================ Reverse String ================
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu=$m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʀᴇᴠᴇʀsɪɴɢ ᴛʜᴇ ( `$mu` ) ᴛᴇxᴛ . . . ! ",'parse_mode'=>"MarkDown"]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$matn = strtoupper("$m[2]");
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ 10 ғᴀʀsɪ ғᴏɴᴛs ғᴏʀ ( `$m[2]` ) ɴᴀᴍᴇ . . . ! ",'parse_mode'=>"MarkDown"]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ ᴄᴜʀʀᴇɴᴄʏ ᴘʀɪᴄᴇs . . . !",'parse_mode'=>'MarkDown']);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$matn = strtoupper("$m[2]");
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ 125 ғᴏɴᴛs ғᴏʀ ( `$m[2]` ) ɴᴀᴍᴇ . . . ! ",'parse_mode'=>"MarkDown"]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ( `$m[2]` ) ᴀᴘᴋ . . . !", 'parse_mode' => 'markdown' ]);
...
$matn = strtoupper("$m[2]");
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴡʜᴏɪsɪɴɢ ( `$m[2]` ) ᴅᴏᴍᴀɪɴ . . . !",'parse_mode'=>"MarkDown"]);
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ᴄᴀʟᴄᴜʟᴀᴛᴇ ᴛʜᴇ ( `$match[2]/$match[3]/$match[4]` ) ᴀɢᴇ . . . !",'parse_mode'=>"MarkDown"]);
if($match[2] < 1000 or $match[3] >= 13 or $match[4] >= 32 or $match[2] >= 1400){
$this->messages->sendMessage(['peer' => $peer,
'message'=> "ɪɴᴠᴀʟɪᴅ ғᴏʀᴍᴀᴛ ! ᴘʟᴇᴀsᴇ ᴛʀʏ ᴀɢᴀɪɴ .",'reply_to_msg_id' => $msg_id]);
}
else{
$result = json_decode($get, true);
if($result['ok'] === true){
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mi = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ ᴘɪɴɢ ( `$m[2]` ) ᴡᴇʙsɪᴛᴇ . . . !",'parse_mode'=>"MarkDown"]);
...
$mi = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɢᴇᴛᴛɪɴɢ sᴄʀᴇᴇɴ sʜᴏᴛ ғʀᴏᴍ ( `$m[2]` ) ᴡᴇʙsɪᴛᴇ . . . !",'parse_mode'=>"MarkDown"]);

$r = "https://api.codebazan.ir/webshot/?text=1000&domain=".$mi;
$inputMediaGifExternal = ['_' => 'inputMediaGifExternal', 'url' => $r];
$this->messages->sendMedia(['peer' => $peer, 'media' => $inputMediaGifExternal ,'reply_to_msg_id' => $msg_id,'message' => "» ʏᴏᴜʀ sᴄʀᴇᴇɴ sʜᴏᴛ ɪs ʀᴇᴀᴅʏ =)"]);
}
//============== QR Code Maker ==============
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mi = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ ǫʀ ᴄᴏᴅᴇ ғʀᴏᴍ ( `$m[2]` ) ᴀᴅᴅʀᴇss . . . !",'parse_mode'=>"MarkDown"]);
$brc = "https://api.codebazan.ir/qr/?size=500x500&text=".$mi;
$inputMediaGifExternal = ['_' => 'inputMediaGifExternal', 'url' => $brc];
$this->messages->sendMedia(['peer' => $peer, 'media' => $inputMediaGifExternal ,'reply_to_msg_id' => $msg_id,'message' => "» ʏᴏᴜʀ ǫʀ ᴄᴏᴅᴇ ɪs ʀᴇᴀᴅʏ =)"]);
}}
//============== Kalame ==============
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ ғᴏʀ ( `$m[2]` ) ᴋᴀʟᴀᴍᴇ ɢᴀᴍᴇ . . . !", 'parse_mode' => 'markdown' ]);
...
yield $this->messages->sendMessage(['peer' => $peer, 'message' =>"» ʏᴏᴜʀ ʟᴇᴠᴇʟ ɪs ɪɴᴠᴀʟɪᴅ !",'reply_to_msg_id' => $msg_id]);
}
}}
//============== Gif Maker ==============
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mi = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ ғᴏʀ ( `$m[2]` ) ɢɪғ . . . !",'parse_mode'=>"MarkDown"]);
...
$inputMediaGifExternal = ['_' => 'inputMediaGifExternal', 'url' => $r];
$this->messages->sendMedia(['peer' => $peer, 'media' => $inputMediaGifExternal ,'reply_to_msg_id' => $msg_id,'message' => "» ʏᴏᴜʀ ɢɪғ ɪs ʀᴇᴀᴅʏ =)"]);
}}
//============== Link Logo ==============
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ɪᴄᴏɴ ʟɪɴᴋ sᴇɴᴅ ɪɴ ʏᴏᴜʀ ᴘᴠ . . . !",'parse_mode'=>"MarkDown"]);
...
$mu = str_replace(" ","%20",$mu);
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ ғᴏʀ ( `$m[2]` ) ɪᴄᴏɴ . . . !
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sᴀᴠᴇᴅ =)"]);
}
//============== Full Info ==============
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ( `$m[2]` ) ᴍᴇᴍᴇ . . . !", 'parse_mode' => 'markdown' ]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ( `$m[2]` ) ᴍᴜsɪᴄ . . . !", 'parse_mode' => 'markdown' ]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ( `$m[2]` ) ᴘɪᴄᴛᴜʀᴇ . . . !", 'parse_mode' => 'markdown' ]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sᴇᴀʀᴄʜɪɴɢ ғᴏʀ ( `$m[2]` ) ɢɪғ . . . !", 'parse_mode' => 'markdown' ]);
...
if($type3 == "supergroup"||$type3 == "chat"||$type3 == 'user'){
$mu = $m[2];
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» ʙᴜɪʟᴅɪɴɢ ʏᴏᴜʀ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴs . . . !"]);
...
yield $this->messages->editMessage(['peer' => $peer,'id' => $msg_id,'message' => "» sʜᴇᴀʀᴄʜɪɴɢ ғᴏʀ ɢʀᴏᴜᴘ ɪɴғᴏʀᴍᴀᴛɪᴏɴ . . . !"]);
...
if( $type3 != 'channel' ) {
	...
	//Enemy Check
	$fohsh = [
		"کیرم کون مادرت😂😂😂😂","بالا باش کیرم کص مادرت😂😂😂","مادرتو میگام نوچه جون بالا😂😂😂","اب خارکصته تند تند تایپ کن ببینم","مادرتو میگام بخای فرار کنی","لال شو دیگه نوچه","مادرتو میگام اف بشی","کیرم کون مادرت","کیرم کص مص مادرت بالا","کیرم تو چشو چال مادرت","کون مادرتو میگام بالا","بیناموس	خسته شدی؟","نبینم خسته بشی بیناموس","ننتو میکنم","کیرم کون مادرت 😂😂😂😂😂😂😂","صلف تو کصننت بالا","بیناموس بالا باش بهت میگم","کیر تو مادرت","کص مص مادرتو بلیسم؟","کص مادرتو چنگ بزنم؟","به خدا کصننت بالا ","مادرتو میگام ","کیرم کون مادرت بیناموس","مادرجنده بالا باش","بیناموس تا کی میخای سطحت گح باشه","اپدیت شو بیناموس خز بود","ای تورک خر بالا ببینم","و اما تو بیناموس چموش","تو یکیو مادرتو میکنم","کیرم تو ناموصت ","کیر تو ننت","ریش روحانی تو ننت","کیر تو مادرت😂😂😂","کص مادرتو جر بدم","صلف تو ننت","بات تو ننت ","مامانتو میکنم بالا","وای این تورک خرو","سطحشو نگا","تایپ کن بیناموس","خشاب؟","کیرم کون مادرت بالا","بیناموس نبینم خسته بشی","مادرتو بگام؟","گح تو سطحت شرفت رف","بیناموس شرفتو نابود کردم یه کاری کن","وای کیرم تو سطحت","بیناموس روانی شدی","روانیت کردما","مادرتو کردم کاری کن","تایپ تو ننت","بیپدر بالا باش","و اما تو لر خر","ننتو میکنم بالا باش","کیرم لب مادرت بالا😂😂😂","چطوره بزنم نصلتو گح کنم","داری تظاهر میکنی ارومی ولی مادرتو کص کردم","مادرتو کردم بیغیرت","هرزه","وای خدای من اینو نگا","کیر تو کصننت","ننتو بلیسم","منو نگا بیناموس","کیر تو ننت بسه دیگه","خسته شدی؟","ننتو میکنم خسته بشی","وای دلم کون مادرت بگام","اف شو احمق","بیشرف اف شو بهت میگم","مامان جنده اف شو","کص مامانت اف شو","کص لش وا ول کن اینجوری بگو؟","ای بیناموس چموش","خارکصته ای ها","مامانتو میکنم اف نشی","گح تو ننت","سطح یه گح صفتو","گح کردم تو نصلتا","چه رویی داری بیناموس","ناموستو کردم","رو کص مادرت کیر کنم؟😂😂😂","نوچه بالا","کیرم تو ناموصتاا😂😂","یا مادرتو میگام یا اف میشی","لالشو دیگه","بیناموس","مادرکصته","ناموص کصده","وای بدو ببینم میرسی","کیرم کون مادرت چیکار میکنی اخه","خارکصته بالا دیگه عه","کیرم کصمادرت😂😂😂","کیرم کون ناموصد😂😂😂","بیناموس من خودم خسته شدم توچی؟","ای شرف ندار","مامانتو کردم بیغیرت","و اما مادر جندت","تو یکی زیر باش","اف شو","خارتو کص میکنم","کصناموصد","ناموص کونی","خارکصته ی بۍ غیرت","شرم کن بیناموس","مامانتو کرد ","ای مادرجنده","بیغیرت","کیرتو ناموصت","بیناموس نمیخای اف بشی؟","ای خارکصته","لالشو دیگه","همه کس کونی","حرامزاده","مادرتو میکنم","بیناموس","کص ننت","اف شو مادرکصته","خارکصته کجایی","ننتو کردم کاری نمیکنی؟","کیرتو مادرت لال","کیرتو ننت بسه","کیرتو شرفت","مادرتو میگام بالا","کیر تو مادرت"
	];
