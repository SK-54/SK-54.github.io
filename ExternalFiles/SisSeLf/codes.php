						...
						if ($type3 == "supergroup" or $type3 == "chat") {
							...
							if (in_array($messag, $data["enemies"])) {
								...
								yield $this->messages->editMessage([
									"peer" => $peer,
									"id" => $msg_id,
									"message" => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ ᴇɴᴇᴍʏ ʟɪsᴛ !",
									"parse_mode" => "MarkDown",
								]);
							} else {
								yield $this->messages->editMessage([
									"peer" => $peer,
									"id" => $msg_id,
									"message" => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɪs ɴᴏᴛ ɪɴ ᴛʜᴇ ᴇɴᴇᴍʏ ʟɪsᴛ !",
									"parse_mode" => "MarkDown",
								]);
							}
						}
				...
				if (
					...
					if (!in_array($peer, $data["enemies"])) {
						...
						yield $this->messages->editMessage([
							"peer" => $peer,
							"id" => $msg_id,
							"message" => "ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$peer) ᴡᴀs ɪɴ ᴇɴᴇᴍʏ ʟɪsᴛ !",
							"parse_mode" => "MarkDown",
						]);
					}
				}
						...
						if ($type3 == "supergroup" or $type3 == "chat") {
							...
							if (in_array($messag, $data["silents"])) {
								...
								yield $this->messages->editMessage([
									"peer" => $peer,
									"id" => $msg_id,
									"message" => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴅᴇʟᴇᴛᴇᴅ ғʀᴏᴍ sɪʟᴇɴᴛ ʟɪsᴛ !",
									"parse_mode" => "MarkDown",
								]);
							} else {
								yield $this->messages->editMessage([
									"peer" => $peer,
									"id" => $msg_id,
									"message" => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɪs ɴᴏᴛ ɪɴ ᴛʜᴇ sɪʟᴇɴᴛ ʟɪsᴛ !",
									"parse_mode" => "MarkDown",
								]);
							}
						}
						...
						if ($type3 == "supergroup" or $type3 == "chat") {
							...
							if (!in_array($messag, $data["silents"])) {
								...
								yield $this->messages->editMessage([
									"peer" => $peer,
									"id" => $msg_id,
									"message" => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ɴᴏᴡ ɪɴ sɪʟᴇɴᴛ ʟɪsᴛ !",
									"parse_mode" => "MarkDown",
								]);
							} else {
								yield $this->messages->editMessage([
									"peer" => $peer,
									"id" => $msg_id,
									"message" => "» ᴛʜɪs [ᴜsᴇʀ](tg://user?id=$messag) ᴡᴀs ɪɴ sɪʟᴇɴᴛ ʟɪsᴛ !",
									"parse_mode" => "MarkDown",
								]);
							}
						}
